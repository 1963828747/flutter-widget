  ...
  Widget build(BuildContext context) {
    return ClipPath(
      ...
      child: Container(
        ...
        color: this.color,
        padding: EdgeInsets.fromLTRB(0, 0.0, 0, 0.0).add(this.padding??EdgeInsets.fromLTRB(7.0, 5.0, 7.0, 5.0)),
        child: this.child,
      ),
    );
  }
...
class _BubbleClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    print(centerPoint);
    if (this.direction == BubbleDirection.right) {
      //绘制左边三角形
