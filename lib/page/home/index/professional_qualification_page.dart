...
class ProfessionalQualificationPage extends StatefulWidget {
  @override
  _ProfessionalQualificationPageState createState() => _ProfessionalQualificationPageState();
}

class _ProfessionalQualificationPageState extends State<ProfessionalQualificationPage> {
  @override
  var _imgPath;
  var _imgPath2;
  List images =[];
